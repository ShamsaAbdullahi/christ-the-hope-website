export const siteConfig = {
  ...
  donationTiers: [
    { amount: 500, label: 'KES 500', impact: 'Feeds one child for a day' },
    { amount: 1000, label: 'KES 1,000', impact: 'School supplies for a week' },
    { amount: 5000, label: 'KES 5,000', impact: 'Supports one child for a month' },
  ],
};
