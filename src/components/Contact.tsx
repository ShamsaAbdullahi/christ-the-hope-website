          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-11 h-11 bg-white/10 hover:bg-cth-purple rounded-full flex items-center justify-center transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 bg-white/10 hover:bg-cth-green rounded-full flex items-center justify-center transition-colors"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
